...
//  source: ./gigapaxos/src/edu/umass/cs/gigapaxos/PaxosConfig.java
//
...
+ (void)ensureFileHandlerDirExists;
...
FOUNDATION_EXPORT void EduUmassCsGigapaxosPaxosConfig_ensureFileHandlerDirExists();
