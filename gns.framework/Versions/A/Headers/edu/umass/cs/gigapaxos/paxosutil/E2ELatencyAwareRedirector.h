...
//  source: ./gigapaxos/src/edu/umass/cs/gigapaxos/paxosutil/E2ELatencyAwareRedirector.java
//
...
- (void)setMinProbeTimeWithLong:(jlong)time;

- (void)setProbeRatioWithDouble:(jdouble)ratio;
